...
class Sampler:
    ...
    def __init__(self, case_name='test_traj_3D'):
        self.data_root = os.path.join(Script_Root, "DATA", case_name, 'data_set')
        self.data_list = []
    ...
    def split_data(self, file):
        ...
        data = np.hstack((kappa, n, alpha, delta, rec_diff))
        num = data.shape[0]
    ...
    def save_data(self):
        ...
        head = ['curvature', 'n', 'alpha', 'delta', 'rec_diff']
