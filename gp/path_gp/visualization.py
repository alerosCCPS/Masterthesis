...
class SimPlotter:
    ...
    def plot_traj(self):
        ...
        plt.savefig(os.path.join(self.data_path, "gp_sim.pdf"), bbox_inches='tight',pad_inches=0.01)
        plt.show()
...
class ResultePlotter:
    ...
    def plot(self):
        ...
        plt.savefig(os.path.join(self.data_root, "gp_X_opt.pdf"), bbox_inches='tight',pad_inches=0.01)
        plt.show()
        ...
        plt.savefig(os.path.join(self.data_root, "gp_U_opt.pdf"), bbox_inches='tight',pad_inches=0.01)
        plt.show()
