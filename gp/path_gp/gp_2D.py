...
class Trainer:
    ...
    def plot_feature_space(self, e):
        ...
        plt.savefig(os.path.join(self.data_root, self.case_name, 'feature_space.pdf'),bbox_inches = 'tight', pad_inches = 0.01)
        plt.show()
    ...
    def save_model(self):
        ...
        }, os.path.join(self.data_root,self.case_name, 'gp_2D.pth'))
