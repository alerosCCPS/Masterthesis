...
class Trainer:
    ...
    def plot_feature_space(self, e):
        ...
        sc = ax.scatter(data[:,0], data[:,1], data[:,2], c=np.abs(e), cmap=cm, norm=norm, marker='o')
    ...
    def save_model(self):
        ...
        }, os.path.join(self.data_root,self.case_name, 'gp_2D_LF.pth'))
    ...
    def load_data(self, path):
        ...
        x = torch.tensor(np.hstack((lf, n, alpha))).to(self.data_type)
