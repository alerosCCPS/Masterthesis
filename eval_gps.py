...
class GPEval:
    ...
    def __init__(self):
        ...
        self.datalist = ["train_data_10","train_data_25","train_data_33","train_data_50", "train_data_66", "train_data_75", "train_data_80", "train_data"]
    ...
    def sim(self, gp, tra):
        ...
        for data_file in self.datalist:
            ...
            for flag in [True, False]:
                ...
                simulator.start_sim()
                data_path = os.path.join(self.root_path, "gp", "DATA", case_name, "gp_sim_results.csv")
